    ...
    <div className=" bg-white p-5 flex flex-col gap-8 font-jakarta">
      <div>
        ...
        <p className="font-normal text-xl text-[#104901] opacity-80">
          Control how and when you receive notifications about your campaigns
        </p>
      </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("notifyOnCampaignDonation", checked)
                }
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("notifyOnLargeDonation", checked)
                }
                disabled={!settings?.emailNotificationsEnabled}
              />
            </div>
              ...
              settings?.emailNotificationsEnabled && (
                <div className="space-y-2 pl-4 border-l-2 border-yellow-400">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("largeDonationThreshold", e.target.value)
                    }
                    min="1"
                  />
                  <p className="text-xs text-gray-500">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("notifyOnPayoutRequest", checked)
                }
                disabled={!settings?.emailNotificationsEnabled}
              />
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("dailySummaryEnabled", checked)
                }
                disabled={!settings?.emailNotificationsEnabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSetting("weeklySummaryEnabled", checked)
                }
                disabled={!settings?.emailNotificationsEnabled}
              />
            </div>
              ...
              settings?.emailNotificationsEnabled && (
                <div className="space-y-2 pl-4 border-l-2 border-blue-400">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSetting("summaryTime", e.target.value)
                    }
                  />
                  <p className="text-xs text-gray-500">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 mb-1">
                  How Your Notifications Work
                </h3>
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>
                    • <strong>Campaign Donations:</strong> Get instant alerts
                    when someone supports your campaign
                  </li>
                  <li>
                    • <strong>Large Donation Alerts:</strong> Special
                    notifications for major contributions to your campaign
                  </li>
                  <li>
                    • <strong>Payout Updates:</strong> Know when your campaign
                    funds are ready to withdraw
                  </li>
                  <li>
                    • <strong>Summary Reports:</strong> Periodic overviews of
                    your campaign&apos;s performance
                  </li>
                </ul>
                <p className="text-xs text-blue-700 mt-3">
                  💡 Tip: Keep notifications enabled to stay connected with your
                  supporters!
                </p>
              </div>
            </div>
