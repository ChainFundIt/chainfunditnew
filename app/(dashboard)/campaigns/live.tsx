...
const LiveCampaigns = ({ campaigns }: Props) => {
  ...
  // Debug logging
  console.log('LiveCampaigns: campaigns prop changed, length:', campaigns.length);
  console.log('LiveCampaigns: campaignIds:', campaignIds);
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  {/* Time Remaining */}
                  <div className="flex justify-between text-xs text-[#104901] opacity-80">
                    <span>Time Remaining</span>
                    <span className="font-semibold">
                      {(() => {
                        const originalCampaign = campaigns.find(c => c.id === campaign.id);
                        return originalCampaign ? getTimeRemaining(originalCampaign) : 'Ongoing';
                      })()}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <Link href={`/campaign/${campaign.id}`} className="flex-1">
                    <Button
                      className="w-full bg-[#F2F1E9] text-[#474553] border-[#474553] hover:bg-[#474553] hover:text-white rounded-xl py-2 transition-all duration-300"
                      variant="outline"
                    >
