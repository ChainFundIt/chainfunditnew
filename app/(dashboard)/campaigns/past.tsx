...
const PastCampaigns = (props: Props) => {
  return (
    <div className="flex flex-col gap-4">
      ...
      <Button className="w-[300px] h-16 flex justify-between font-semibold text-2xl items-center">Create a Campaign <Plus size={24} /></Button>
    </div>
  )
}
