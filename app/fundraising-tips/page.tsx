...
export default function FundraisingTipsPage() {
  return (
    <div className="font-jakarta">
      <Navbar />
      {/* Header Box */}
      <div className="flex items-center justify-center pt-20 px-[270px] pb-[140px] bg-[#FCFAF5]">
        <div className="flex flex-col gap-6 px-4 items-center justify-center md:max-w-[56rem] text-center">
          ...
          <div className="font-extrabold text-[60px] leading-[60px] text-[#104109]">
            Essential Fundraising Startegies
          </div>
