...
const Main = (props: Props) => {
  ...
  // Amounts (replace with props or state if dynamic)
  const raised = 1192000;
  const goal = 3000000;
      ...
      <div className="flex md:flex-row md:gap-5 flex-col">
        ...
        <div className="w-full md:w-3/5">
          ...
          <p className="font-medium text-2xl text-[#757575] md:my-1 my-3">
            Organised by{" "}
            <span className="font-semibold text-[#104901]">Donald Chopra</span>{" "}
            for the{" "}
            <span className="font-semibold text-[#104901]">Thomas family</span>
          </p>
       ...
       <CTA />
       <ChainModal open={chainModalOpen} onOpenChange={setChainModalOpen} />
