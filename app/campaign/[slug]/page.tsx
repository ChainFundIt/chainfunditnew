...
export async function generateMetadata({
  ...
  // Always provide a deterministic OG image first (generated by our app),
  // and include the raw/proxied cover as a secondary option for platforms that support it.
  const images = [
    {
